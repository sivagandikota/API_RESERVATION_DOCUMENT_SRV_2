...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderTextTypeCreate;
...
public class APISALESORDERSRVASalesOrderTypecreateToText {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderTextTypeCreate> results = null;

  public APISALESORDERSRVASalesOrderTypecreateToText results(List<APISALESORDERSRVASalesOrderTextTypeCreate> results) {
    this.results = results;
    return this;
  }

  public APISALESORDERSRVASalesOrderTypecreateToText addResultsItem(APISALESORDERSRVASalesOrderTextTypeCreate resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderTextTypeCreate>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderTextTypeCreate> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderTextTypeCreate> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APISALESORDERSRVASalesOrderTypecreateToText apISALESORDERSRVASalesOrderTypecreateToText = (APISALESORDERSRVASalesOrderTypecreateToText) o;
    return Objects.equals(this.results, apISALESORDERSRVASalesOrderTypecreateToText.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class APISALESORDERSRVASalesOrderTypecreateToText {\n");
