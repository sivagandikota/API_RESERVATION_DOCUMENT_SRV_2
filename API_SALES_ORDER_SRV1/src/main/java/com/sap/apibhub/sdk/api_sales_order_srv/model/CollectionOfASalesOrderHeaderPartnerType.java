...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderHeaderPartnerType;
...
public class CollectionOfASalesOrderHeaderPartnerType {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderHeaderPartnerType> results = null;

  public CollectionOfASalesOrderHeaderPartnerType results(List<APISALESORDERSRVASalesOrderHeaderPartnerType> results) {
    this.results = results;
    return this;
  }

  public CollectionOfASalesOrderHeaderPartnerType addResultsItem(APISALESORDERSRVASalesOrderHeaderPartnerType resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderHeaderPartnerType>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderHeaderPartnerType> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderHeaderPartnerType> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CollectionOfASalesOrderHeaderPartnerType collectionOfASalesOrderHeaderPartnerType = (CollectionOfASalesOrderHeaderPartnerType) o;
    return Objects.equals(this.results, collectionOfASalesOrderHeaderPartnerType.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionOfASalesOrderHeaderPartnerType {\n");
