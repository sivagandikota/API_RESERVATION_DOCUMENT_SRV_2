...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate;
...
public class APISALESORDERSRVASalesOrderTypecreateToPricingElement {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate> results = null;

  public APISALESORDERSRVASalesOrderTypecreateToPricingElement results(List<APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate> results) {
    this.results = results;
    return this;
  }

  public APISALESORDERSRVASalesOrderTypecreateToPricingElement addResultsItem(APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APISALESORDERSRVASalesOrderTypecreateToPricingElement apISALESORDERSRVASalesOrderTypecreateToPricingElement = (APISALESORDERSRVASalesOrderTypecreateToPricingElement) o;
    return Objects.equals(this.results, apISALESORDERSRVASalesOrderTypecreateToPricingElement.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class APISALESORDERSRVASalesOrderTypecreateToPricingElement {\n");
