...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderHeaderPrElementType;
...
public class CollectionOfASalesOrderHeaderPrElementType {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderHeaderPrElementType> results = null;

  public CollectionOfASalesOrderHeaderPrElementType results(List<APISALESORDERSRVASalesOrderHeaderPrElementType> results) {
    this.results = results;
    return this;
  }

  public CollectionOfASalesOrderHeaderPrElementType addResultsItem(APISALESORDERSRVASalesOrderHeaderPrElementType resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderHeaderPrElementType>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderHeaderPrElementType> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderHeaderPrElementType> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CollectionOfASalesOrderHeaderPrElementType collectionOfASalesOrderHeaderPrElementType = (CollectionOfASalesOrderHeaderPrElementType) o;
    return Objects.equals(this.results, collectionOfASalesOrderHeaderPrElementType.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionOfASalesOrderHeaderPrElementType {\n");
