...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderItemPartnerType;
...
public class CollectionOfASalesOrderItemPartnerType {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderItemPartnerType> results = null;

  public CollectionOfASalesOrderItemPartnerType results(List<APISALESORDERSRVASalesOrderItemPartnerType> results) {
    this.results = results;
    return this;
  }

  public CollectionOfASalesOrderItemPartnerType addResultsItem(APISALESORDERSRVASalesOrderItemPartnerType resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderItemPartnerType>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderItemPartnerType> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderItemPartnerType> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CollectionOfASalesOrderItemPartnerType collectionOfASalesOrderItemPartnerType = (CollectionOfASalesOrderItemPartnerType) o;
    return Objects.equals(this.results, collectionOfASalesOrderItemPartnerType.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionOfASalesOrderItemPartnerType {\n");
