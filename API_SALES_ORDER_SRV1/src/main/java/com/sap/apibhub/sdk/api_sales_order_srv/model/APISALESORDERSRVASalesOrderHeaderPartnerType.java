...
/**
 * Sales Order Header Partner (API)
 */
@ApiModel(description = "Sales Order Header Partner (API)")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-08-07T13:59:02.462Z")
public class APISALESORDERSRVASalesOrderHeaderPartnerType {
  ...
  public APISALESORDERSRVASalesOrderHeaderPartnerType salesOrder(String salesOrder) {
  ...
  **/
  ...
  public APISALESORDERSRVASalesOrderHeaderPartnerType partnerFunction(String partnerFunction) {
  ...
  **/
  ...
  public APISALESORDERSRVASalesOrderHeaderPartnerType toSalesOrder(APISALESORDERSRVASalesOrderType toSalesOrder) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APISALESORDERSRVASalesOrderHeaderPartnerType apISALESORDERSRVASalesOrderHeaderPartnerType = (APISALESORDERSRVASalesOrderHeaderPartnerType) o;
    return Objects.equals(this.salesOrder, apISALESORDERSRVASalesOrderHeaderPartnerType.salesOrder) &&
        Objects.equals(this.partnerFunction, apISALESORDERSRVASalesOrderHeaderPartnerType.partnerFunction) &&
        Objects.equals(this.toSalesOrder, apISALESORDERSRVASalesOrderHeaderPartnerType.toSalesOrder);
  }

  @Override
  public int hashCode() {
    return Objects.hash(salesOrder, partnerFunction, toSalesOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class APISALESORDERSRVASalesOrderHeaderPartnerType {\n");
