...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate;
...
public class APISALESORDERSRVASalesOrderTypecreateToPartner {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate> results = null;

  public APISALESORDERSRVASalesOrderTypecreateToPartner results(List<APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate> results) {
    this.results = results;
    return this;
  }

  public APISALESORDERSRVASalesOrderTypecreateToPartner addResultsItem(APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderHeaderPartnerTypeCreate> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APISALESORDERSRVASalesOrderTypecreateToPartner apISALESORDERSRVASalesOrderTypecreateToPartner = (APISALESORDERSRVASalesOrderTypecreateToPartner) o;
    return Objects.equals(this.results, apISALESORDERSRVASalesOrderTypecreateToPartner.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class APISALESORDERSRVASalesOrderTypecreateToPartner {\n");
