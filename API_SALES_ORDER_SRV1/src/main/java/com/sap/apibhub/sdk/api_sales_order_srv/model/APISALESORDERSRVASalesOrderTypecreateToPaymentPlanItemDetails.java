...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate;
...
public class APISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails {
  @SerializedName("results")
  private List<APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate> results = null;

  public APISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails results(List<APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate> results) {
    this.results = results;
    return this;
  }

  public APISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails addResultsItem(APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails apISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails = (APISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails) o;
    return Objects.equals(this.results, apISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class APISALESORDERSRVASalesOrderTypecreateToPaymentPlanItemDetails {\n");
