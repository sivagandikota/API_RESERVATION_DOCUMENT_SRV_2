...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderScheduleLineType;
...
public class CollectionOfASalesOrderScheduleLineType {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderScheduleLineType> results = null;

  public CollectionOfASalesOrderScheduleLineType results(List<APISALESORDERSRVASalesOrderScheduleLineType> results) {
    this.results = results;
    return this;
  }

  public CollectionOfASalesOrderScheduleLineType addResultsItem(APISALESORDERSRVASalesOrderScheduleLineType resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderScheduleLineType>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderScheduleLineType> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderScheduleLineType> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CollectionOfASalesOrderScheduleLineType collectionOfASalesOrderScheduleLineType = (CollectionOfASalesOrderScheduleLineType) o;
    return Objects.equals(this.results, collectionOfASalesOrderScheduleLineType.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionOfASalesOrderScheduleLineType {\n");
