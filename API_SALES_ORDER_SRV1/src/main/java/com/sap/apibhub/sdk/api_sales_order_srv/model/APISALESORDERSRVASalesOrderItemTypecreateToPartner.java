...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderItemPartnerTypeCreate;
...
public class APISALESORDERSRVASalesOrderItemTypecreateToPartner {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderItemPartnerTypeCreate> results = null;

  public APISALESORDERSRVASalesOrderItemTypecreateToPartner results(List<APISALESORDERSRVASalesOrderItemPartnerTypeCreate> results) {
    this.results = results;
    return this;
  }

  public APISALESORDERSRVASalesOrderItemTypecreateToPartner addResultsItem(APISALESORDERSRVASalesOrderItemPartnerTypeCreate resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderItemPartnerTypeCreate>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderItemPartnerTypeCreate> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderItemPartnerTypeCreate> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APISALESORDERSRVASalesOrderItemTypecreateToPartner apISALESORDERSRVASalesOrderItemTypecreateToPartner = (APISALESORDERSRVASalesOrderItemTypecreateToPartner) o;
    return Objects.equals(this.results, apISALESORDERSRVASalesOrderItemTypecreateToPartner.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class APISALESORDERSRVASalesOrderItemTypecreateToPartner {\n");
