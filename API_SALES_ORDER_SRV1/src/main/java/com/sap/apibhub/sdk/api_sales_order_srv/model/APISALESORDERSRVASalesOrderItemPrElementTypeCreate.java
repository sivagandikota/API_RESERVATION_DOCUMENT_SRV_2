...
public class APISALESORDERSRVASalesOrderItemPrElementTypeCreate {
  ...
  private APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem = null;

  public APISALESORDERSRVASalesOrderItemPrElementTypeCreate pricingProcedureStep(String pricingProcedureStep) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Number that determines the sequence of the condition within a procedure.")
  ...
  public APISALESORDERSRVASalesOrderItemPrElementTypeCreate pricingProcedureCounter(String pricingProcedureCounter) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Condition Counter   Access number of the conditions within a step in the pricing procedure.   During automatic pricing, the system takes into account the sequence specified by the counter.")
  ...
  public APISALESORDERSRVASalesOrderItemPrElementTypeCreate toSalesOrder(APISALESORDERSRVASalesOrderTypeCreate toSalesOrder) {
  ...
  **/
  ...
  public APISALESORDERSRVASalesOrderItemPrElementTypeCreate toSalesOrderItem(APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem) {
  ...
  **/
  @ApiModelProperty(value = "")
  public APISALESORDERSRVASalesOrderItemTypeCreate getToSalesOrderItem() {
    return toSalesOrderItem;
  }

  public void setToSalesOrderItem(APISALESORDERSRVASalesOrderItemTypeCreate toSalesOrderItem) {
    this.toSalesOrderItem = toSalesOrderItem;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    APISALESORDERSRVASalesOrderItemPrElementTypeCreate apISALESORDERSRVASalesOrderItemPrElementTypeCreate = (APISALESORDERSRVASalesOrderItemPrElementTypeCreate) o;
    return Objects.equals(this.pricingProcedureStep, apISALESORDERSRVASalesOrderItemPrElementTypeCreate.pricingProcedureStep) &&
        Objects.equals(this.pricingProcedureCounter, apISALESORDERSRVASalesOrderItemPrElementTypeCreate.pricingProcedureCounter) &&
        Objects.equals(this.toSalesOrder, apISALESORDERSRVASalesOrderItemPrElementTypeCreate.toSalesOrder) &&
        Objects.equals(this.toSalesOrderItem, apISALESORDERSRVASalesOrderItemPrElementTypeCreate.toSalesOrderItem);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pricingProcedureStep, pricingProcedureCounter, toSalesOrder, toSalesOrderItem);
  }
  ...
  public String toString() {
    ...
    sb.append("class APISALESORDERSRVASalesOrderItemPrElementTypeCreate {\n");
