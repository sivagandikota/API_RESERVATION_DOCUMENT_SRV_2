...
import com.sap.apibhub.sdk.api_sales_order_srv.model.APISALESORDERSRVASalesOrderItemPrElementType;
...
public class CollectionOfASalesOrderItemPrElementType {
  @SerializedName("results")
  private List<APISALESORDERSRVASalesOrderItemPrElementType> results = null;

  public CollectionOfASalesOrderItemPrElementType results(List<APISALESORDERSRVASalesOrderItemPrElementType> results) {
    this.results = results;
    return this;
  }

  public CollectionOfASalesOrderItemPrElementType addResultsItem(APISALESORDERSRVASalesOrderItemPrElementType resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<APISALESORDERSRVASalesOrderItemPrElementType>();
    }
  ...
  **/
  ...
  public List<APISALESORDERSRVASalesOrderItemPrElementType> getResults() {
    return results;
  }

  public void setResults(List<APISALESORDERSRVASalesOrderItemPrElementType> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CollectionOfASalesOrderItemPrElementType collectionOfASalesOrderItemPrElementType = (CollectionOfASalesOrderItemPrElementType) o;
    return Objects.equals(this.results, collectionOfASalesOrderItemPrElementType.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class CollectionOfASalesOrderItemPrElementType {\n");
